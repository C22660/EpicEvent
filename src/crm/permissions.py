...
#------- L'admin à accès à toutes les autorisations, un gestionnaire doit
# pouvoir afficher et modifier toutes les données du CRM--------
...
class ClientsPermissions(BasePermission):
    ...
    message = "Permission refusée : seul un commercial peut créer un client." \
    ...
    def has_permission(self, request, view):
        ...
        if request.user.is_authenticated:
            ...
            if request.user.is_sales and request.method in sales_methods:
                print("request.user.is_sales")
                return True
...
class ContractsPermissions(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        print("commercial_attached_to_client", commercial_attached_to_client)
        print("request.user = ", request.user)
        sales_methods = ("GET", "POST", "PUT", "DELETE",)
        management_methods = ("GET", "PUT",)
